...
import '../assets/Style/Coupon/CustomerCouponsList.css'; 
  ...
  return (
    <div className="Money-transfer-list">
      ...
      <div className="header">
        <h2>Customer Coupons List <span className="subheader" style={{fontSize:'10px'}}>View/Search Items Brand</span></h2>
        <p>Home<span> / </span><span>Customer Coupons List</span></p>
      </div>

      {/* Filters Section */}
      <div className="filters">
        <div className="list-header">
          <h3>Customer Coupons List</h3>
